...
describe(__filename, function() {
    it("simple route with argument", function() {
    ...
    it("simple route with number argument", function() {
        var route = new Route(
            "/user/:id",
            {
                params: {
    ...
    it("for params if the value is a string it is treated as the type", function() {
        var route = new Route(
            "/user/:id",
            {
                params: {
    ...
    it("complex route with wildcard arguments", function() {
        var route = new Route(
            "/user/:name/:rest*",
            {
                params: {
    ...
    it("complex route with multiple arguments", function() {
        var route = new Route(
            "/user/:name/:id",
            {
                params: {
    ...
    it("test custom type without register", function() {
        var DateType = {
    ...
    it("decode parameter in body", function(next) {
        var route = new Route(
            "/user",
            {
                params: {
    ...
    it("decode parameter in body with defaults", function(next) {
        var route = new Route(
            "/user",
            {
                params: {
    ...
    it("optional number argument can be falsy", function(next) {
        var route = new Route(
            "/user",
            {
                params: {
